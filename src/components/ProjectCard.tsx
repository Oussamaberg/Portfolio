...
function ProjectCard({
  ...
  return (
    ...
    <div className=" grid grid-cols-2 gap-1 place-items-stretch sm:flex justify-center ">
        {techArray.map((item, index) => (
          <span
            key={index}
            className="  border-[1px] border-green-400 text-green-400 text-xs rounded-full px-2 py-1 flex justify-center"
          >
            {item}
          </span>
        ))}
